...
class Translations with BaseTranslations<AppLocale, Translations> {
	...
	late final Translations$funscriptSync$en funscriptSync = Translations$funscriptSync$en.internal(_root);
...
class Translations$auth$en {
	...
	/// en: 'Pleazy could not safely recover local sign-in and pending playback data. Please sign in again.'
	String get localDataRecoveryRequired => 'Pleazy could not safely recover local sign-in and pending playback data. Please sign in again.';
...
class Translations$settings$en {
	...
	/// en: 'Support Pleazy'
	String get supportDeveloper => 'Support Pleazy';
	...
	/// en: 'This file isn't a valid Pleazy settings export'
	String get importSettingsInvalidFile => 'This file isn\'t a valid Pleazy settings export';
	...
	/// en: 'Open Pleazy in fullscreen mode at launch'
	String get startInFullscreenDescription => 'Open Pleazy in fullscreen mode at launch';
	...
	/// en: 'Export Pleazy settings'
	String get exportDialogTitle => 'Export Pleazy settings';
}
...
class Translations$mediaMenu$en {
	...
	/// en: 'Pleazy could not check which files this will remove, so it may delete more than the item named above. Cancel and try again, or delete anyway.'
	String get deleteScopeUnverifiedProbeFailed => 'Pleazy could not check which files this will remove, so it may delete more than the item named above. Cancel and try again, or delete anyway.';

	/// en: 'Your server did not provide file details for this item, so Pleazy cannot check which files this will remove. It may delete more than the item named above.'
	String get deleteScopeUnverifiedNoFileInfo => 'Your server did not provide file details for this item, so Pleazy cannot check which files this will remove. It may delete more than the item named above.';
...
class Translations$profiles$en {
	...
	/// en: 'Add Pleazy profile'
	String get addPlezyProfile => 'Add Pleazy profile';
...
class Translations$connections$en {
	...
	/// en: 'Add or remove URLs for ${serverName}. Pleazy will use the reachable URL with the lowest latency.'
	String editMediaBrowserIntro({required Object serverName}) => 'Add or remove URLs for ${serverName}. Pleazy will use the reachable URL with the lowest latency.';
}
...
class Translations$accountPreferences$en {
	...
	/// en: 'These options are saved on the account itself, so every app signed in to it uses them — including Pleazy on your other devices.'
	String get storedOnAccount => 'These options are saved on the account itself, so every app signed in to it uses them — including Pleazy on your other devices.';
...
class Translations$startup$en {
	...
	/// en: 'Pleazy could not start'
	String get failedTitle => 'Pleazy could not start';
	...
	/// en: 'Pleazy's saved settings file is damaged and has to be rebuilt before Pleazy can start. Retrying will not help — choose Repair storage.'
	String get failedBodyRepairable => 'Pleazy\'s saved settings file is damaged and has to be rebuilt before Pleazy can start. Retrying will not help — choose Repair storage.';
	...
	/// en: 'Pleazy's settings file is damaged and cannot be read. Repairing resets every setting to its default.'
	String get repairBodyCommon => 'Pleazy\'s settings file is damaged and cannot be read. Repairing resets every setting to its default.';
	...
	/// en: 'Trackers (MAL, AniList, Simkl, Trakt) and Seerr are stored separately and may or may not survive. Pleazy will tell you exactly what it kept.'
	String get repairBodySessionsUncertain => 'Trackers (MAL, AniList, Simkl, Trakt) and Seerr are stored separately and may or may not survive. Pleazy will tell you exactly what it kept.';
	...
	/// en: 'Your data was repaired, but Pleazy has to start fresh before it can use it. Close Pleazy and open it again.'
	String get restartRequiredBody => 'Your data was repaired, but Pleazy has to start fresh before it can use it. Close Pleazy and open it again.';

	/// en: 'Quit Pleazy'
	String get quitPlezy => 'Quit Pleazy';
	...
	/// en: 'Pleazy failed to start last time'
	String get previousFailureTitle => 'Pleazy failed to start last time';
}
...
class Translations$trakt$en {
	...
	/// en: 'Pleazy will stop sending events to Trakt. You can reconnect any time.'
	String get disconnectConfirmBody => 'Pleazy will stop sending events to Trakt. You can reconnect any time.';
	...
	/// en: 'When you mark items as watched in Pleazy, they are also marked as watched on Trakt.'
	String get watchedSyncDescription => 'When you mark items as watched in Pleazy, they are also marked as watched on Trakt.';
}
...
class Translations$seerr$en {
	...
	/// en: 'This Seerr instance offers no sign-in method Pleazy supports.'
	String get noSignInMethods => 'This Seerr instance offers no sign-in method Pleazy supports.';
	...
	/// en: 'Pleazy will forget this Seerr instance. Reconnect any time.'
	String get disconnectConfirmBody => 'Pleazy will forget this Seerr instance. Reconnect any time.';
	...
	/// en: 'An authenticating reverse proxy (SSO or HTTP auth) answered instead of Seerr. Pleazy cannot sign in through it: let Seerr's /api/v1 path bypass the proxy for this app, or use an address that reaches Seerr directly.'
	String get behindAuthProxy => 'An authenticating reverse proxy (SSO or HTTP auth) answered instead of Seerr. Pleazy cannot sign in through it: let Seerr\'s /api/v1 path bypass the proxy for this app, or use an address that reaches Seerr directly.';
...
class Translations$services$en {
	...
	/// en: 'Pleazy will stop updating ${service}. Reconnect any time.'
	String disconnectConfirmBody({required Object service}) => 'Pleazy will stop updating ${service}. Reconnect any time.';
...
// Path: funscriptSync
class Translations$funscriptSync$en {
	Translations$funscriptSync$en.internal(this._root);
	...
	/// en: 'FunScriptSync'
	String get title => 'FunScriptSync';

	/// en: 'Configure the local FunScriptSync server.'
	String get connectionSubtitle => 'Configure the local FunScriptSync server.';

	/// en: 'Server address'
	String get serverUrl => 'Server address';

	/// en: 'Include protocol and port, for example http://192.168.178.50:3000'
	String get serverUrlHelper => 'Include protocol and port, for example http://192.168.178.50:3000';

	/// en: 'FunScriptSync secret'
	String get secret => 'FunScriptSync secret';

	/// en: 'Uses the same WEBHOOK_SECRET as the Jellyfin webhook.'
	String get secretHelper => 'Uses the same WEBHOOK_SECRET as the Jellyfin webhook.';

	/// en: 'Test connection'
	String get testConnection => 'Test connection';

	/// en: 'Testing connectionâ€¦'
	String get testing => 'Testing connectionâ€¦';

	/// en: 'Connected to FunScriptSync successfully.'
	String get connectionSuccessful => 'Connected to FunScriptSync successfully.';

	/// en: 'Delete Stash scene'
	String get deleteActiveScene => 'Delete Stash scene';

	/// en: 'Delete the Stash scene currently active in FunScriptSync?'
	String get deleteConfirmation => 'Delete the Stash scene currently active in FunScriptSync?';
...
class Translations$downloads$backgroundWarning$en {
	...
	/// en: 'Android is preventing Pleazy from downloading reliably in the background.'
	String get sheetIntro => 'Android is preventing Pleazy from downloading reliably in the background.';

	/// en: 'Your device is limiting when Pleazy can download in the background.'
	String get sheetIntroDegraded => 'Your device is limiting when Pleazy can download in the background.';

	/// en: 'Pleazy's background usage is restricted. Set its battery or background usage to "Unrestricted".'
	String get reasonBackgroundRestricted => 'Pleazy\'s background usage is restricted. Set its battery or background usage to "Unrestricted".';

	/// en: 'Android has put Pleazy in a restricted standby state. Set its battery usage to "Unrestricted".'
	String get reasonStandbyRestricted => 'Android has put Pleazy in a restricted standby state. Set its battery usage to "Unrestricted".';
	...
	/// en: 'Downloads repeatedly stopped while Pleazy was in the background. Check Pleazy's battery or background usage settings.'
	String get reasonOemUnknown => 'Downloads repeatedly stopped while Pleazy was in the background. Check Pleazy\'s battery or background usage settings.';
...
class Translations$companionRemote$pairing$en {
	...
	/// en: 'Pleazy devices with the same Plex account appear here'
	String get discoveryDescription => 'Pleazy devices with the same Plex account appear here';
	...
	/// en: 'Open Pleazy on desktop and use the same Wi-Fi'
	String get noDevicesHint => 'Open Pleazy on desktop and use the same Wi-Fi';
	...
	/// en: 'Device not found. Make sure Pleazy is running on the host.'
	String get sessionNotFound => 'Device not found. Make sure Pleazy is running on the host.';
...
class Translations$services$deviceCode$en {
	...
	/// en: 'Activate Pleazy on ${service}'
	String title({required Object service}) => 'Activate Pleazy on ${service}';
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'auth.localDataRecoveryRequired' => 'Pleazy could not safely recover local sign-in and pending playback data. Please sign in again.',
			...
			'settings.supportDeveloper' => 'Support Pleazy',
			...
			'settings.importSettingsInvalidFile' => 'This file isn\'t a valid Pleazy settings export',
			...
			'settings.startInFullscreenDescription' => 'Open Pleazy in fullscreen mode at launch',
			...
			'settings.exportDialogTitle' => 'Export Pleazy settings',
			...
			'mediaMenu.deleteScopeUnverifiedProbeFailed' => 'Pleazy could not check which files this will remove, so it may delete more than the item named above. Cancel and try again, or delete anyway.',
			'mediaMenu.deleteScopeUnverifiedNoFileInfo' => 'Your server did not provide file details for this item, so Pleazy cannot check which files this will remove. It may delete more than the item named above.',
			...
			'profiles.addPlezyProfile' => 'Add Pleazy profile',
			...
			'connections.editMediaBrowserIntro' => ({required Object serverName}) => 'Add or remove URLs for ${serverName}. Pleazy will use the reachable URL with the lowest latency.',
			...
			'accountPreferences.storedOnAccount' => 'These options are saved on the account itself, so every app signed in to it uses them — including Pleazy on your other devices.',
			...
			'startup.failedTitle' => 'Pleazy could not start',
			'startup.failedBody' => 'Something went wrong during startup. The details below identify what failed.',
			'startup.failedBodyRepairable' => 'Pleazy\'s saved settings file is damaged and has to be rebuilt before Pleazy can start. Retrying will not help — choose Repair storage.',
			...
			'startup.repairBodyCommon' => 'Pleazy\'s settings file is damaged and cannot be read. Repairing resets every setting to its default.',
			...
			'startup.repairBodySessionsUncertain' => 'Trackers (MAL, AniList, Simkl, Trakt) and Seerr are stored separately and may or may not survive. Pleazy will tell you exactly what it kept.',
			...
			'startup.restartRequiredBody' => 'Your data was repaired, but Pleazy has to start fresh before it can use it. Close Pleazy and open it again.',
			'startup.quitPlezy' => 'Quit Pleazy',
			...
			'startup.previousFailureTitle' => 'Pleazy failed to start last time',
			...
			'downloads.backgroundWarning.sheetIntro' => 'Android is preventing Pleazy from downloading reliably in the background.',
			'downloads.backgroundWarning.sheetIntroDegraded' => 'Your device is limiting when Pleazy can download in the background.',
			'downloads.backgroundWarning.reasonBackgroundRestricted' => 'Pleazy\'s background usage is restricted. Set its battery or background usage to "Unrestricted".',
			'downloads.backgroundWarning.reasonStandbyRestricted' => 'Android has put Pleazy in a restricted standby state. Set its battery usage to "Unrestricted".',
			...
			'downloads.backgroundWarning.reasonOemUnknown' => 'Downloads repeatedly stopped while Pleazy was in the background. Check Pleazy\'s battery or background usage settings.',
			...
			'companionRemote.pairing.discoveryDescription' => 'Pleazy devices with the same Plex account appear here',
			...
			'companionRemote.pairing.noDevicesHint' => 'Open Pleazy on desktop and use the same Wi-Fi',
			...
			'companionRemote.pairing.sessionNotFound' => 'Device not found. Make sure Pleazy is running on the host.',
			...
			'trakt.disconnectConfirmBody' => 'Pleazy will stop sending events to Trakt. You can reconnect any time.',
			...
			'trakt.watchedSyncDescription' => 'When you mark items as watched in Pleazy, they are also marked as watched on Trakt.',
			'seerr.title' => 'Seerr',
			...
			'seerr.email' => 'Email',
			'seerr.noSignInMethods' => 'This Seerr instance offers no sign-in method Pleazy supports.',
			'seerr.instance' => 'Instance',
			'seerr.disconnectConfirm' => 'Disconnect Seerr?',
			'seerr.disconnectConfirmBody' => 'Pleazy will forget this Seerr instance. Reconnect any time.',
			...
			'seerr.behindAuthProxy' => 'An authenticating reverse proxy (SSO or HTTP auth) answered instead of Seerr. Pleazy cannot sign in through it: let Seerr\'s /api/v1 path bypass the proxy for this app, or use an address that reaches Seerr directly.',
			...
			'services.disconnectConfirmBody' => ({required Object service}) => 'Pleazy will stop updating ${service}. Reconnect any time.',
			...
			'services.deviceCode.title' => ({required Object service}) => 'Activate Pleazy on ${service}',
			...
			'funscriptSync.title' => 'FunScriptSync',
			'funscriptSync.connectionSubtitle' => 'Configure the local FunScriptSync server.',
			'funscriptSync.serverUrl' => 'Server address',
			'funscriptSync.serverUrlHelper' => 'Include protocol and port, for example http://192.168.178.50:3000',
			'funscriptSync.secret' => 'FunScriptSync secret',
			'funscriptSync.secretHelper' => 'Uses the same WEBHOOK_SECRET as the Jellyfin webhook.',
			'funscriptSync.testConnection' => 'Test connection',
			'funscriptSync.testing' => 'Testing connectionâ€¦',
			'funscriptSync.connectionSuccessful' => 'Connected to FunScriptSync successfully.',
			'funscriptSync.deleteActiveScene' => 'Delete Stash scene',
			'funscriptSync.deleteConfirmation' => 'Delete the Stash scene currently active in FunScriptSync?',
