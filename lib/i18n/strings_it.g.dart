...
class _Translations$auth$it extends Translations$auth$en {
	...
	@override String get localDataRecoveryRequired => 'Pleazy non è riuscito a recuperare in sicurezza i dati locali di accesso e delle riproduzioni in sospeso. Accedi di nuovo.';
...
class _Translations$settings$it extends Translations$settings$en {
	...
	@override String get supportDeveloper => 'Supporta Pleazy';
	...
	@override String get importSettingsInvalidFile => 'Questo file non è un\'esportazione Pleazy valida';
	...
	@override String get startInFullscreenDescription => 'Apri Pleazy a schermo intero all\'avvio';
	...
	@override String get exportDialogTitle => 'Esporta le impostazioni di Pleazy';
}
...
class _Translations$mediaMenu$it extends Translations$mediaMenu$en {
	...
	@override String get deleteScopeUnverifiedProbeFailed => 'Pleazy non ha potuto verificare quali file rimuoverà, quindi potrebbe eliminare più di quanto indicato sopra. Annulla e riprova, oppure elimina comunque.';
	@override String get deleteScopeUnverifiedNoFileInfo => 'Il tuo server non ha fornito i dettagli del file per questo elemento, quindi Pleazy non può verificare quali file rimuoverà. Potrebbe eliminare più di quanto indicato sopra.';
...
class _Translations$profiles$it extends Translations$profiles$en {
	...
	// Translations
	@override String get addPlezyProfile => 'Aggiungi profilo Pleazy';
...
class _Translations$connections$it extends Translations$connections$en {
	...
	@override String editMediaBrowserIntro({required Object serverName}) => 'Aggiungi o rimuovi gli URL per ${serverName}. Pleazy userà l\'URL raggiungibile con la latenza più bassa.';
}
...
class _Translations$accountPreferences$it extends Translations$accountPreferences$en {
	...
	@override String get storedOnAccount => 'Queste opzioni vengono salvate sull\'account stesso, quindi ogni app che vi accede le usa — inclusa Pleazy sugli altri tuoi dispositivi.';
...
class _Translations$startup$it extends Translations$startup$en {
	...
	// Translations
	@override String get failedTitle => 'Pleazy non ha potuto avviarsi';
	...
	@override String get failedBodyRepairable => 'Il file delle impostazioni salvate di Pleazy è danneggiato e deve essere ricostruito prima che Pleazy possa avviarsi. Riprovare non servirà: scegli Ripara storage.';
	...
	@override String get repairBodyCommon => 'Il file delle impostazioni di Pleazy è danneggiato e non può essere letto. La riparazione ripristina ogni impostazione al suo valore predefinito.';
	...
	@override String get repairBodySessionsUncertain => 'I tracker (MAL, AniList, Simkl, Trakt) e Seerr sono archiviati separatamente e potrebbero sopravvivere o meno. Pleazy ti dirà esattamente cosa ha conservato.';
	...
	@override String get restartRequiredBody => 'I tuoi dati sono stati riparati, ma Pleazy deve ripartire da zero prima di poterli usare. Chiudi Pleazy e riaprilo.';
	@override String get quitPlezy => 'Esci da Pleazy';
	...
	@override String get previousFailureTitle => 'Pleazy non è riuscito ad avviarsi l\'ultima volta';
}
...
class _Translations$trakt$it extends Translations$trakt$en {
	...
	@override String get disconnectConfirmBody => 'Pleazy smetterà di inviare eventi a Trakt. Puoi riconnetterti quando vuoi.';
	...
	@override String get watchedSyncDescription => 'Quando contrassegni un elemento come visto in Pleazy, viene contrassegnato come visto anche su Trakt.';
}
...
class _Translations$seerr$it extends Translations$seerr$en {
	...
	@override String get noSignInMethods => 'Questa istanza Seerr non offre alcun metodo di accesso supportato da Pleazy.';
	@override String get instance => 'Istanza';
	@override String get disconnectConfirm => 'Disconnettere Seerr?';
	@override String get disconnectConfirmBody => 'Pleazy rimuoverà questa istanza Seerr. Potrai riconnetterla in qualsiasi momento.';
...
class _Translations$services$it extends Translations$services$en {
	...
	@override String disconnectConfirmBody({required Object service}) => 'Pleazy smetterà di aggiornare ${service}. Riconnetti quando vuoi.';
...
class _Translations$downloads$backgroundWarning$it extends Translations$downloads$backgroundWarning$en {
	...
	@override String get sheetIntro => 'Android impedisce a Pleazy di scaricare in modo affidabile in background.';
	@override String get sheetIntroDegraded => 'Il dispositivo limita i momenti in cui Pleazy può scaricare in background.';
	@override String get reasonBackgroundRestricted => 'L’uso in background di Pleazy è limitato. Nelle impostazioni della batteria o dell’uso in background, seleziona «Senza restrizioni».';
	@override String get reasonStandbyRestricted => 'Android ha messo Pleazy in uno stato di standby con restrizioni. Imposta l’uso della batteria su «Senza restrizioni».';
	...
	@override String get reasonOemUnknown => 'I download si sono interrotti più volte mentre Pleazy era in background. Controlla le impostazioni della batteria o dell’uso in background di Pleazy.';
...
class _Translations$companionRemote$pairing$it extends Translations$companionRemote$pairing$en {
	...
	// Translations
	@override String get discoveryDescription => 'I dispositivi Pleazy con lo stesso account Plex appaiono qui';
	...
	@override String get noDevicesHint => 'Apri Pleazy sul computer e usa la stessa rete Wi-Fi';
	...
	@override String get sessionNotFound => 'Dispositivo non trovato. Assicurati che Pleazy sia in esecuzione sull\'host.';
...
class _Translations$services$deviceCode$it extends Translations$services$deviceCode$en {
	...
	// Translations
	@override String title({required Object service}) => 'Attiva Pleazy su ${service}';
...
extension on TranslationsIt {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'auth.localDataRecoveryRequired' => 'Pleazy non è riuscito a recuperare in sicurezza i dati locali di accesso e delle riproduzioni in sospeso. Accedi di nuovo.',
			...
			'settings.supportDeveloper' => 'Supporta Pleazy',
			...
			'settings.importSettingsInvalidFile' => 'Questo file non è un\'esportazione Pleazy valida',
			...
			'settings.startInFullscreenDescription' => 'Apri Pleazy a schermo intero all\'avvio',
			...
			'settings.exportDialogTitle' => 'Esporta le impostazioni di Pleazy',
			...
			'mediaMenu.deleteScopeUnverifiedProbeFailed' => 'Pleazy non ha potuto verificare quali file rimuoverà, quindi potrebbe eliminare più di quanto indicato sopra. Annulla e riprova, oppure elimina comunque.',
			'mediaMenu.deleteScopeUnverifiedNoFileInfo' => 'Il tuo server non ha fornito i dettagli del file per questo elemento, quindi Pleazy non può verificare quali file rimuoverà. Potrebbe eliminare più di quanto indicato sopra.',
			...
			'profiles.addPlezyProfile' => 'Aggiungi profilo Pleazy',
			...
			'connections.editMediaBrowserIntro' => ({required Object serverName}) => 'Aggiungi o rimuovi gli URL per ${serverName}. Pleazy userà l\'URL raggiungibile con la latenza più bassa.',
			...
			'accountPreferences.storedOnAccount' => 'Queste opzioni vengono salvate sull\'account stesso, quindi ogni app che vi accede le usa — inclusa Pleazy sugli altri tuoi dispositivi.',
			...
			'startup.failedTitle' => 'Pleazy non ha potuto avviarsi',
			'startup.failedBody' => 'Si è verificato un errore durante l\'avvio. I dettagli seguenti indicano cosa non ha funzionato.',
			'startup.failedBodyRepairable' => 'Il file delle impostazioni salvate di Pleazy è danneggiato e deve essere ricostruito prima che Pleazy possa avviarsi. Riprovare non servirà: scegli Ripara storage.',
			...
			'startup.repairBodyCommon' => 'Il file delle impostazioni di Pleazy è danneggiato e non può essere letto. La riparazione ripristina ogni impostazione al suo valore predefinito.',
			...
			'startup.repairBodySessionsUncertain' => 'I tracker (MAL, AniList, Simkl, Trakt) e Seerr sono archiviati separatamente e potrebbero sopravvivere o meno. Pleazy ti dirà esattamente cosa ha conservato.',
			...
			'startup.restartRequiredBody' => 'I tuoi dati sono stati riparati, ma Pleazy deve ripartire da zero prima di poterli usare. Chiudi Pleazy e riaprilo.',
			'startup.quitPlezy' => 'Esci da Pleazy',
			...
			'startup.previousFailureTitle' => 'Pleazy non è riuscito ad avviarsi l\'ultima volta',
			...
			'downloads.backgroundWarning.sheetIntro' => 'Android impedisce a Pleazy di scaricare in modo affidabile in background.',
			'downloads.backgroundWarning.sheetIntroDegraded' => 'Il dispositivo limita i momenti in cui Pleazy può scaricare in background.',
			'downloads.backgroundWarning.reasonBackgroundRestricted' => 'L’uso in background di Pleazy è limitato. Nelle impostazioni della batteria o dell’uso in background, seleziona «Senza restrizioni».',
			'downloads.backgroundWarning.reasonStandbyRestricted' => 'Android ha messo Pleazy in uno stato di standby con restrizioni. Imposta l’uso della batteria su «Senza restrizioni».',
			...
			'downloads.backgroundWarning.reasonOemUnknown' => 'I download si sono interrotti più volte mentre Pleazy era in background. Controlla le impostazioni della batteria o dell’uso in background di Pleazy.',
			...
			'companionRemote.pairing.discoveryDescription' => 'I dispositivi Pleazy con lo stesso account Plex appaiono qui',
			...
			'companionRemote.pairing.noDevicesHint' => 'Apri Pleazy sul computer e usa la stessa rete Wi-Fi',
			...
			'companionRemote.pairing.sessionNotFound' => 'Dispositivo non trovato. Assicurati che Pleazy sia in esecuzione sull\'host.',
			...
			'trakt.disconnectConfirmBody' => 'Pleazy smetterà di inviare eventi a Trakt. Puoi riconnetterti quando vuoi.',
			...
			'trakt.watchedSyncDescription' => 'Quando contrassegni un elemento come visto in Pleazy, viene contrassegnato come visto anche su Trakt.',
			'seerr.title' => 'Seerr',
			...
			'seerr.email' => 'Email',
			'seerr.noSignInMethods' => 'Questa istanza Seerr non offre alcun metodo di accesso supportato da Pleazy.',
			'seerr.instance' => 'Istanza',
			'seerr.disconnectConfirm' => 'Disconnettere Seerr?',
			'seerr.disconnectConfirmBody' => 'Pleazy rimuoverà questa istanza Seerr. Potrai riconnetterla in qualsiasi momento.',
			...
			'services.disconnectConfirmBody' => ({required Object service}) => 'Pleazy smetterà di aggiornare ${service}. Riconnetti quando vuoi.',
			...
			'services.deviceCode.title' => ({required Object service}) => 'Attiva Pleazy su ${service}',
