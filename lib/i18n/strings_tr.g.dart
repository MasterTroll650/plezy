...
class _Translations$auth$tr extends Translations$auth$en {
	...
	@override String get localDataRecoveryRequired => 'Pleazy yerel giriş ve bekleyen oynatma verilerini güvenli bir şekilde kurtaramadı. Lütfen tekrar giriş yapın.';
...
class _Translations$settings$tr extends Translations$settings$en {
	...
	@override String get supportDeveloper => 'Pleazy\'yi Destekleyin';
	...
	@override String get importSettingsInvalidFile => 'Bu dosya geçerli bir Pleazy ayar dosyası değil';
	...
	@override String get startInFullscreenDescription => 'Pleazy\'yi açılışta tam ekran modunda aç';
	...
	@override String get exportDialogTitle => 'Pleazy ayarlarını dışa aktar';
}
...
class _Translations$mediaMenu$tr extends Translations$mediaMenu$en {
	...
	@override String get deleteScopeUnverifiedProbeFailed => 'Pleazy bunun hangi dosyaları sileceğini kontrol edemedi, bu yüzden yukarıda adı geçen ögeden daha fazlasını silebilir. İptal edip tekrar deneyin veya yine de silin.';
	@override String get deleteScopeUnverifiedNoFileInfo => 'Sunucunuz bu öge için dosya ayrıntıları sağlamadı, bu yüzden Pleazy bunun hangi dosyaları sileceğini kontrol edemiyor. Yukarıda adı geçen ögeden daha fazlasını silebilir.';
...
class _Translations$profiles$tr extends Translations$profiles$en {
	...
	// Translations
	@override String get addPlezyProfile => 'Pleazy profili ekle';
...
class _Translations$connections$tr extends Translations$connections$en {
	...
	@override String editMediaBrowserIntro({required Object serverName}) => '${serverName} için URL ekleyin veya kaldırın. Pleazy, erişilebilir olan en düşük gecikmeli URL\'yi kullanacak.';
}
...
class _Translations$accountPreferences$tr extends Translations$accountPreferences$en {
	...
	@override String get storedOnAccount => 'Bu seçenekler hesabın kendisine kaydedilir; böylece hesaba giriş yapan her uygulama bunları kullanır — diğer cihazlarınızdaki Pleazy dahil.';
...
class _Translations$startup$tr extends Translations$startup$en {
	...
	// Translations
	@override String get failedTitle => 'Pleazy başlatılamadı';
	...
	@override String get failedBodyRepairable => 'Pleazy\'nin kayıtlı ayar dosyası hasarlı ve Pleazy başlamadan önce yeniden oluşturulması gerekiyor. Tekrar denemek işe yaramaz — Depolama Alanını Onar\'ı seçin.';
	...
	@override String get repairBodyCommon => 'Pleazy\'nin ayar dosyası hasarlı ve okunamıyor. Onarım, her ayarı varsayılanına sıfırlar.';
	...
	@override String get repairBodySessionsUncertain => 'Takip hizmetleri (MAL, AniList, Simkl, Trakt) ve Seerr ayrı olarak saklanır; korunup korunmayacakları belirsizdir. Pleazy tam olarak neyi koruduğunu size söyleyecek.';
	...
	@override String get restartRequiredBody => 'Verileriniz onarıldı, ancak Pleazy\'nin bunları kullanabilmesi için temiz bir başlangıç yapması gerekiyor. Pleazy\'yi kapatıp yeniden açın.';
	@override String get quitPlezy => 'Pleazy\'den Çık';
	...
	@override String get previousFailureTitle => 'Pleazy geçen sefer başlatılamadı';
}
...
class _Translations$trakt$tr extends Translations$trakt$en {
	...
	@override String get disconnectConfirmBody => 'Pleazy, Trakt\'a olay göndermeyi durduracak. İstediğiniz zaman yeniden bağlanabilirsiniz.';
	...
	@override String get watchedSyncDescription => 'Pleazy\'de ögeleri izlendi olarak işaretlediğinizde, Trakt üzerinde de izlendi olarak işaretlenir.';
}
...
class _Translations$seerr$tr extends Translations$seerr$en {
	...
	@override String get noSignInMethods => 'Bu Seerr örneği Pleazy\'nin desteklediği bir giriş yöntemi sunmuyor.';
	@override String get instance => 'Örnek (Instance)';
	@override String get disconnectConfirm => 'Seerr bağlantısı kesilsin mi?';
	@override String get disconnectConfirmBody => 'Pleazy bu Seerr örneğini unutacak. İstediğiniz zaman yeniden bağlanabilirsiniz.';
...
class _Translations$services$tr extends Translations$services$en {
	...
	@override String disconnectConfirmBody({required Object service}) => 'Pleazy, ${service} güncellemeyi durduracak. İstediğiniz zaman yeniden bağlanabilirsiniz.';
...
class _Translations$downloads$backgroundWarning$tr extends Translations$downloads$backgroundWarning$en {
	...
	@override String get sheetIntro => 'Android, Pleazy\'nin arka planda güvenilir şekilde indirme yapmasını engelliyor.';
	@override String get sheetIntroDegraded => 'Cihazınız, Pleazy\'nin arka planda ne zaman indirme yapabileceğini sınırlıyor.';
	@override String get reasonBackgroundRestricted => 'Pleazy\'nin arka plan kullanımı kısıtlanmış. Pil veya arka plan kullanımını "Kısıtlanmamış" olarak ayarlayın.';
	@override String get reasonStandbyRestricted => 'Android, Pleazy\'yi kısıtlı bekleme durumuna aldı. Pil kullanımını "Kısıtlanmamış" olarak ayarlayın.';
	...
	@override String get reasonOemUnknown => 'Pleazy arka plandayken indirmeler tekrar tekrar durdu. Pleazy\'nin pil veya arka plan kullanım ayarlarını kontrol edin.';
...
class _Translations$companionRemote$pairing$tr extends Translations$companionRemote$pairing$en {
	...
	// Translations
	@override String get discoveryDescription => 'Aynı Plex hesabına sahip Pleazy cihazları burada görünür';
	...
	@override String get noDevicesHint => 'Masaüstünde Pleazy\'yi açın ve aynı Wi-Fi ağını kullanın';
	...
	@override String get sessionNotFound => 'Cihaz bulunamadı. Pleazy\'nin ana bilgisayarda çalıştığından emin olun.';
...
class _Translations$services$deviceCode$tr extends Translations$services$deviceCode$en {
	...
	// Translations
	@override String title({required Object service}) => 'Pleazy\'yi ${service} üzerinde etkinleştirin';
...
extension on TranslationsTr {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'auth.localDataRecoveryRequired' => 'Pleazy yerel giriş ve bekleyen oynatma verilerini güvenli bir şekilde kurtaramadı. Lütfen tekrar giriş yapın.',
			...
			'settings.supportDeveloper' => 'Pleazy\'yi Destekleyin',
			...
			'settings.importSettingsInvalidFile' => 'Bu dosya geçerli bir Pleazy ayar dosyası değil',
			...
			'settings.startInFullscreenDescription' => 'Pleazy\'yi açılışta tam ekran modunda aç',
			...
			'settings.exportDialogTitle' => 'Pleazy ayarlarını dışa aktar',
			...
			'mediaMenu.deleteScopeUnverifiedProbeFailed' => 'Pleazy bunun hangi dosyaları sileceğini kontrol edemedi, bu yüzden yukarıda adı geçen ögeden daha fazlasını silebilir. İptal edip tekrar deneyin veya yine de silin.',
			'mediaMenu.deleteScopeUnverifiedNoFileInfo' => 'Sunucunuz bu öge için dosya ayrıntıları sağlamadı, bu yüzden Pleazy bunun hangi dosyaları sileceğini kontrol edemiyor. Yukarıda adı geçen ögeden daha fazlasını silebilir.',
			...
			'profiles.addPlezyProfile' => 'Pleazy profili ekle',
			...
			'connections.editMediaBrowserIntro' => ({required Object serverName}) => '${serverName} için URL ekleyin veya kaldırın. Pleazy, erişilebilir olan en düşük gecikmeli URL\'yi kullanacak.',
			...
			'accountPreferences.storedOnAccount' => 'Bu seçenekler hesabın kendisine kaydedilir; böylece hesaba giriş yapan her uygulama bunları kullanır — diğer cihazlarınızdaki Pleazy dahil.',
			...
			'startup.failedTitle' => 'Pleazy başlatılamadı',
			'startup.failedBody' => 'Başlatma sırasında bir şeyler ters gitti. Aşağıdaki ayrıntılar neyin başarısız olduğunu gösteriyor.',
			'startup.failedBodyRepairable' => 'Pleazy\'nin kayıtlı ayar dosyası hasarlı ve Pleazy başlamadan önce yeniden oluşturulması gerekiyor. Tekrar denemek işe yaramaz — Depolama Alanını Onar\'ı seçin.',
			...
			'startup.repairBodyCommon' => 'Pleazy\'nin ayar dosyası hasarlı ve okunamıyor. Onarım, her ayarı varsayılanına sıfırlar.',
			...
			'startup.repairBodySessionsUncertain' => 'Takip hizmetleri (MAL, AniList, Simkl, Trakt) ve Seerr ayrı olarak saklanır; korunup korunmayacakları belirsizdir. Pleazy tam olarak neyi koruduğunu size söyleyecek.',
			...
			'startup.restartRequiredBody' => 'Verileriniz onarıldı, ancak Pleazy\'nin bunları kullanabilmesi için temiz bir başlangıç yapması gerekiyor. Pleazy\'yi kapatıp yeniden açın.',
			'startup.quitPlezy' => 'Pleazy\'den Çık',
			...
			'startup.previousFailureTitle' => 'Pleazy geçen sefer başlatılamadı',
			...
			'downloads.backgroundWarning.sheetIntro' => 'Android, Pleazy\'nin arka planda güvenilir şekilde indirme yapmasını engelliyor.',
			'downloads.backgroundWarning.sheetIntroDegraded' => 'Cihazınız, Pleazy\'nin arka planda ne zaman indirme yapabileceğini sınırlıyor.',
			'downloads.backgroundWarning.reasonBackgroundRestricted' => 'Pleazy\'nin arka plan kullanımı kısıtlanmış. Pil veya arka plan kullanımını "Kısıtlanmamış" olarak ayarlayın.',
			'downloads.backgroundWarning.reasonStandbyRestricted' => 'Android, Pleazy\'yi kısıtlı bekleme durumuna aldı. Pil kullanımını "Kısıtlanmamış" olarak ayarlayın.',
			...
			'downloads.backgroundWarning.reasonOemUnknown' => 'Pleazy arka plandayken indirmeler tekrar tekrar durdu. Pleazy\'nin pil veya arka plan kullanım ayarlarını kontrol edin.',
			...
			'companionRemote.pairing.discoveryDescription' => 'Aynı Plex hesabına sahip Pleazy cihazları burada görünür',
			...
			'companionRemote.pairing.noDevicesHint' => 'Masaüstünde Pleazy\'yi açın ve aynı Wi-Fi ağını kullanın',
			...
			'companionRemote.pairing.sessionNotFound' => 'Cihaz bulunamadı. Pleazy\'nin ana bilgisayarda çalıştığından emin olun.',
			...
			'trakt.disconnectConfirmBody' => 'Pleazy, Trakt\'a olay göndermeyi durduracak. İstediğiniz zaman yeniden bağlanabilirsiniz.',
			...
			'trakt.watchedSyncDescription' => 'Pleazy\'de ögeleri izlendi olarak işaretlediğinizde, Trakt üzerinde de izlendi olarak işaretlenir.',
			'seerr.title' => 'Seerr',
			...
			'seerr.email' => 'E-posta',
			'seerr.noSignInMethods' => 'Bu Seerr örneği Pleazy\'nin desteklediği bir giriş yöntemi sunmuyor.',
			'seerr.instance' => 'Örnek (Instance)',
			'seerr.disconnectConfirm' => 'Seerr bağlantısı kesilsin mi?',
			'seerr.disconnectConfirmBody' => 'Pleazy bu Seerr örneğini unutacak. İstediğiniz zaman yeniden bağlanabilirsiniz.',
			...
			'services.disconnectConfirmBody' => ({required Object service}) => 'Pleazy, ${service} güncellemeyi durduracak. İstediğiniz zaman yeniden bağlanabilirsiniz.',
			...
			'services.deviceCode.title' => ({required Object service}) => 'Pleazy\'yi ${service} üzerinde etkinleştirin',
