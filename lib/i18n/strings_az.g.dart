...
class _Translations$auth$az extends Translations$auth$en {
	...
	@override String get localDataRecoveryRequired => 'Pleazy yerli daxil olma və gözləyən oxutma məlumatlarını təhlükəsiz bərpa edə bilmədi. Lütfən təzədən daxil olun.';
...
class _Translations$settings$az extends Translations$settings$en {
	...
	@override String get supportDeveloper => 'Pleazy-yə dəstək ol';
	...
	@override String get importSettingsInvalidFile => 'Bu fayl düzgün Pleazy tənzimləmələr faylı deyil';
	...
	@override String get startInFullscreenDescription => 'Pleazy-ni açılışda tam ekran rejimində aç';
	...
	@override String get exportDialogTitle => 'Pleazy tənzimləmələrini ixrac et';
}
...
class _Translations$mediaMenu$az extends Translations$mediaMenu$en {
	...
	@override String get deleteScopeUnverifiedProbeFailed => 'Pleazy bunun hansı faylları siləcəyini yoxlaya bilmədi, ona görə də yuxarıda adı çəkilən elementdən daha çoxunu silə bilər. Ləğv edib təzədən cəhd edin və ya yenə də silin.';
	@override String get deleteScopeUnverifiedNoFileInfo => 'Serveriniz bu element üçün fayl təfərrüatlarını təqdim etmədi, ona görə Pleazy bunun hansı faylları siləcəyini yoxlaya bilmir. Yuxarıda adı çəkilən elementdən daha çoxunu silə bilər.';
...
class _Translations$profiles$az extends Translations$profiles$en {
	...
	// Translations
	@override String get addPlezyProfile => 'Pleazy profili əlavə et';
...
class _Translations$connections$az extends Translations$connections$en {
	...
	@override String editMediaBrowserIntro({required Object serverName}) => '${serverName} üçün URL-lər əlavə edin və ya silin. Pleazy əlçatan olan ən aşağı gecikməli URL-i istifadə edəcək.';
}
...
class _Translations$accountPreferences$az extends Translations$accountPreferences$en {
	...
	@override String get storedOnAccount => 'Bu seçimlər hesabın özündə saxlanılır, ona görə də ona daxil olan hər tətbiq onlardan istifadə edir — digər cihazlarınızdakı Pleazy də daxil olmaqla.';
...
class _Translations$startup$az extends Translations$startup$en {
	...
	// Translations
	@override String get failedTitle => 'Pleazy başlaya bilmədi';
	@override String get failedBody => 'Başlatma zamanı nəsə səhv getdi. Aşağıdakı təfərrüatlar nəyin uğursuz olduğunu göstərir.';
	@override String get failedBodyRepairable => 'Pleazy-nin saxlanmış tənzimləmə faylı zədələnib və Pleazy başlamazdan əvvəl yenidən qurulmalıdır. Təzədən cəhd etmək kömək etməyəcək — Yaddaşı təmir et seçin.';
	...
	@override String get repairBodyCommon => 'Pleazy-nin tənzimləmə faylı zədələnib və oxuna bilmir. Təmir bütün tənzimləmələri defolt vəziyyətinə sıfırlayır.';
	...
	@override String get repairBodySessionsUncertain => 'İzləyicilər (MAL, AniList, Simkl, Trakt) və Seerr ayrıca saxlanılır və qalıb-qalmayacaqları bəlli deyil. Pleazy sizə nəyi saxladığını dəqiq bildirəcək.';
	...
	@override String get restartRequiredBody => 'Məlumatlarınız təmir edildi, lakin Pleazy ondan istifadə etmək üçün yenidən başlamalıdır. Pleazy-ni bağlayın və yenidən açın.';
	@override String get quitPlezy => 'Pleazy-dən çıx';
	...
	@override String get previousFailureTitle => 'Pleazy son dəfə başlaya bilmədi';
}
...
class _Translations$trakt$az extends Translations$trakt$en {
	...
	@override String get disconnectConfirmBody => 'Pleazy Trakt-a məlumat göndərməyi dayandıracaq.';
	...
	@override String get watchedSyncDescription => 'Pleazy-də baxıldı işarələdikdə Trakt-da da işarələnsin.';
}
...
class _Translations$seerr$az extends Translations$seerr$en {
	...
	@override String get disconnectConfirmBody => 'Pleazy bu Seerr ünvanını unudacaq.';
...
class _Translations$services$az extends Translations$services$en {
	...
	@override String disconnectConfirmBody({required Object service}) => 'Pleazy ${service} yeniləməyi dayandıracaq.';
...
class _Translations$downloads$backgroundWarning$az extends Translations$downloads$backgroundWarning$en {
	...
	@override String get sheetIntro => 'Android Pleazy-nin arxa fonda etibarlı şəkildə yükləməsinə mane olur.';
	@override String get sheetIntroDegraded => 'Cihazınız Pleazy-nin arxa fonda nə vaxt yükləyə biləcəyini məhdudlaşdırır.';
	@override String get reasonBackgroundRestricted => 'Pleazy-nin arxa fon istifadəsi məhdudlaşdırılıb. Batareya və ya arxa fon istifadəsini "Məhdudiyyətsiz" edin.';
	@override String get reasonStandbyRestricted => 'Android Pleazy-ni məhdud gözləmə rejiminə salıb. Batareya istifadəsini "Məhdudiyyətsiz" edin.';
	...
	@override String get reasonOemUnknown => 'Pleazy arxa fonda olarkən yükləmələr dəfələrlə dayandı. Pleazy-nin batareya və ya arxa fon istifadəsi tənzimləmələrini yoxlayın.';
...
class _Translations$companionRemote$pairing$az extends Translations$companionRemote$pairing$en {
	...
	// Translations
	@override String get discoveryDescription => 'Eyni Plex hesabına sahib Pleazy cihazları burada görünür';
	...
	@override String get noDevicesHint => 'Masaüstündə Pleazy-ni açın və eyni Wi-Fi-dan istifadə edin';
...
class _Translations$services$deviceCode$az extends Translations$services$deviceCode$en {
	...
	// Translations
	@override String title({required Object service}) => 'Pleazy-ni ${service} üzərində aktivləşdirin';
...
extension on TranslationsAz {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'auth.localDataRecoveryRequired' => 'Pleazy yerli daxil olma və gözləyən oxutma məlumatlarını təhlükəsiz bərpa edə bilmədi. Lütfən təzədən daxil olun.',
			...
			'settings.supportDeveloper' => 'Pleazy-yə dəstək ol',
			...
			'settings.importSettingsInvalidFile' => 'Bu fayl düzgün Pleazy tənzimləmələr faylı deyil',
			...
			'settings.startInFullscreenDescription' => 'Pleazy-ni açılışda tam ekran rejimində aç',
			...
			'settings.exportDialogTitle' => 'Pleazy tənzimləmələrini ixrac et',
			...
			'mediaMenu.deleteScopeUnverifiedProbeFailed' => 'Pleazy bunun hansı faylları siləcəyini yoxlaya bilmədi, ona görə də yuxarıda adı çəkilən elementdən daha çoxunu silə bilər. Ləğv edib təzədən cəhd edin və ya yenə də silin.',
			'mediaMenu.deleteScopeUnverifiedNoFileInfo' => 'Serveriniz bu element üçün fayl təfərrüatlarını təqdim etmədi, ona görə Pleazy bunun hansı faylları siləcəyini yoxlaya bilmir. Yuxarıda adı çəkilən elementdən daha çoxunu silə bilər.',
			...
			'profiles.addPlezyProfile' => 'Pleazy profili əlavə et',
			...
			'connections.editMediaBrowserIntro' => ({required Object serverName}) => '${serverName} üçün URL-lər əlavə edin və ya silin. Pleazy əlçatan olan ən aşağı gecikməli URL-i istifadə edəcək.',
			...
			'accountPreferences.storedOnAccount' => 'Bu seçimlər hesabın özündə saxlanılır, ona görə də ona daxil olan hər tətbiq onlardan istifadə edir — digər cihazlarınızdakı Pleazy də daxil olmaqla.',
			...
			'startup.failedTitle' => 'Pleazy başlaya bilmədi',
			'startup.failedBody' => 'Başlatma zamanı nəsə səhv getdi. Aşağıdakı təfərrüatlar nəyin uğursuz olduğunu göstərir.',
			'startup.failedBodyRepairable' => 'Pleazy-nin saxlanmış tənzimləmə faylı zədələnib və Pleazy başlamazdan əvvəl yenidən qurulmalıdır. Təzədən cəhd etmək kömək etməyəcək — Yaddaşı təmir et seçin.',
			...
			'startup.repairBodyCommon' => 'Pleazy-nin tənzimləmə faylı zədələnib və oxuna bilmir. Təmir bütün tənzimləmələri defolt vəziyyətinə sıfırlayır.',
			...
			'startup.repairBodySessionsUncertain' => 'İzləyicilər (MAL, AniList, Simkl, Trakt) və Seerr ayrıca saxlanılır və qalıb-qalmayacaqları bəlli deyil. Pleazy sizə nəyi saxladığını dəqiq bildirəcək.',
			...
			'startup.restartRequiredBody' => 'Məlumatlarınız təmir edildi, lakin Pleazy ondan istifadə etmək üçün yenidən başlamalıdır. Pleazy-ni bağlayın və yenidən açın.',
			'startup.quitPlezy' => 'Pleazy-dən çıx',
			...
			'startup.previousFailureTitle' => 'Pleazy son dəfə başlaya bilmədi',
			...
			'downloads.backgroundWarning.sheetIntro' => 'Android Pleazy-nin arxa fonda etibarlı şəkildə yükləməsinə mane olur.',
			'downloads.backgroundWarning.sheetIntroDegraded' => 'Cihazınız Pleazy-nin arxa fonda nə vaxt yükləyə biləcəyini məhdudlaşdırır.',
			'downloads.backgroundWarning.reasonBackgroundRestricted' => 'Pleazy-nin arxa fon istifadəsi məhdudlaşdırılıb. Batareya və ya arxa fon istifadəsini "Məhdudiyyətsiz" edin.',
			'downloads.backgroundWarning.reasonStandbyRestricted' => 'Android Pleazy-ni məhdud gözləmə rejiminə salıb. Batareya istifadəsini "Məhdudiyyətsiz" edin.',
			...
			'downloads.backgroundWarning.reasonOemUnknown' => 'Pleazy arxa fonda olarkən yükləmələr dəfələrlə dayandı. Pleazy-nin batareya və ya arxa fon istifadəsi tənzimləmələrini yoxlayın.',
			...
			'companionRemote.pairing.discoveryDescription' => 'Eyni Plex hesabına sahib Pleazy cihazları burada görünür',
			...
			'companionRemote.pairing.noDevicesHint' => 'Masaüstündə Pleazy-ni açın və eyni Wi-Fi-dan istifadə edin',
			...
			'trakt.disconnectConfirmBody' => 'Pleazy Trakt-a məlumat göndərməyi dayandıracaq.',
			...
			'trakt.watchedSyncDescription' => 'Pleazy-də baxıldı işarələdikdə Trakt-da da işarələnsin.',
			'seerr.title' => 'Seerr',
			...
			'seerr.disconnectConfirmBody' => 'Pleazy bu Seerr ünvanını unudacaq.',
			...
			'services.disconnectConfirmBody' => ({required Object service}) => 'Pleazy ${service} yeniləməyi dayandıracaq.',
			...
			'services.deviceCode.title' => ({required Object service}) => 'Pleazy-ni ${service} üzərində aktivləşdirin',
