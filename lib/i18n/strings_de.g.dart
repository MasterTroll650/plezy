...
class TranslationsDe extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _Translations$funscriptSync$de funscriptSync = _Translations$funscriptSync$de._(_root);
...
class _Translations$auth$de extends Translations$auth$en {
	...
	@override String get localDataRecoveryRequired => 'Pleazy konnte lokale Anmeldedaten und ausstehende Wiedergabedaten nicht sicher wiederherstellen. Bitte melde dich erneut an.';
...
class _Translations$settings$de extends Translations$settings$en {
	...
	@override String get supportDeveloper => 'Pleazy unterstützen';
	...
	@override String get importSettingsInvalidFile => 'Diese Datei ist kein gültiger Pleazy-Einstellungsexport';
	...
	@override String get startInFullscreenDescription => 'Pleazy beim Start im Vollbildmodus öffnen';
	...
	@override String get exportDialogTitle => 'Pleazy-Einstellungen exportieren';
}
...
class _Translations$mediaMenu$de extends Translations$mediaMenu$en {
	...
	@override String get deleteScopeUnverifiedProbeFailed => 'Pleazy konnte nicht prüfen, welche Dateien dadurch entfernt werden. Es könnte also mehr gelöscht werden als das oben genannte Element. Brich ab und versuche es erneut, oder lösche trotzdem.';
	@override String get deleteScopeUnverifiedNoFileInfo => 'Dein Server hat für dieses Element keine Dateidetails bereitgestellt, daher kann Pleazy nicht prüfen, welche Dateien entfernt werden. Es könnte mehr gelöscht werden als das oben genannte Element.';
...
class _Translations$profiles$de extends Translations$profiles$en {
	...
	// Translations
	@override String get addPlezyProfile => 'Pleazy-Profil hinzufügen';
...
class _Translations$connections$de extends Translations$connections$en {
	...
	@override String editMediaBrowserIntro({required Object serverName}) => 'URLs für ${serverName} hinzufügen oder entfernen. Pleazy verwendet die erreichbare URL mit der geringsten Latenz.';
}
...
class _Translations$accountPreferences$de extends Translations$accountPreferences$en {
	...
	@override String get storedOnAccount => 'Diese Optionen werden auf dem Konto selbst gespeichert, sodass jede damit angemeldete App sie verwendet — auch Pleazy auf deinen anderen Geräten.';
...
class _Translations$startup$de extends Translations$startup$en {
	...
	// Translations
	@override String get failedTitle => 'Pleazy konnte nicht gestartet werden';
	@override String get failedBody => 'Beim Start ist etwas schiefgelaufen. Die Details unten zeigen, was fehlgeschlagen ist.';
	@override String get failedBodyRepairable => 'Die gespeicherte Einstellungsdatei von Pleazy ist beschädigt und muss neu aufgebaut werden, bevor Pleazy starten kann. Erneutes Versuchen hilft nicht – wähle „Speicher reparieren“.';
	...
	@override String get repairBodyCommon => 'Die Einstellungsdatei von Pleazy ist beschädigt und kann nicht gelesen werden. Beim Reparieren werden alle Einstellungen auf ihre Standardwerte zurückgesetzt.';
	...
	@override String get repairBodySessionsUncertain => 'Tracker (MAL, AniList, Simkl, Trakt) und Seerr werden separat gespeichert und können erhalten bleiben oder auch nicht. Pleazy teilt dir genau mit, was erhalten blieb.';
	...
	@override String get restartRequiredBody => 'Deine Daten wurden repariert, aber Pleazy muss neu starten, bevor es sie verwenden kann. Schließe Pleazy und öffne es erneut.';
	@override String get quitPlezy => 'Pleazy beenden';
	...
	@override String get previousFailureTitle => 'Pleazy konnte beim letzten Mal nicht starten';
}
...
class _Translations$trakt$de extends Translations$trakt$en {
	...
	@override String get disconnectConfirmBody => 'Pleazy sendet keine Ereignisse mehr an Trakt. Du kannst jederzeit erneut verbinden.';
	...
	@override String get watchedSyncDescription => 'Wenn du Inhalte in Pleazy als gesehen markierst, werden sie auch auf Trakt markiert.';
}
...
class _Translations$seerr$de extends Translations$seerr$en {
	...
	@override String get noSignInMethods => 'Diese Seerr-Instanz bietet keine von Pleazy unterstützte Anmeldemethode.';
	@override String get instance => 'Instanz';
	@override String get disconnectConfirm => 'Seerr trennen?';
	@override String get disconnectConfirmBody => 'Pleazy vergisst diese Seerr-Instanz. Jederzeit erneut verbinden.';
...
class _Translations$services$de extends Translations$services$en {
	...
	@override String disconnectConfirmBody({required Object service}) => 'Pleazy aktualisiert ${service} nicht mehr. Jederzeit erneut verbinden.';
...
// Path: funscriptSync
class _Translations$funscriptSync$de extends Translations$funscriptSync$en {
	_Translations$funscriptSync$de._(TranslationsDe root) : this._root = root, super.internal(root);

	final TranslationsDe _root; // ignore: unused_field

	// Translations
	@override String get title => 'FunScriptSync';
	@override String get connectionSubtitle => 'Lokalen FunScriptSync-Server einrichten.';
	@override String get serverUrl => 'Server-Adresse';
	@override String get serverUrlHelper => 'Protokoll und Port angeben, z. B. http://192.168.178.50:3000';
	@override String get secret => 'FunScriptSync-Secret';
	@override String get secretHelper => 'Verwendet denselben WEBHOOK_SECRET wie der Jellyfin-Webhook.';
	@override String get testConnection => 'Verbindung testen';
	@override String get testing => 'Verbindung wird getestet â€¦';
	@override String get connectionSuccessful => 'Verbindung zu FunScriptSync erfolgreich.';
	@override String get deleteActiveScene => 'Stash Scene löschen';
	@override String get deleteConfirmation => 'Die aktuell in FunScriptSync aktive Stash-Szene löschen?';
	@override String get cancel => 'Abbrechen';
	@override String get delete => 'Löschen';
...
class _Translations$downloads$backgroundWarning$de extends Translations$downloads$backgroundWarning$en {
	...
	@override String get sheetIntro => 'Android verhindert, dass Pleazy zuverlässig im Hintergrund herunterlädt.';
	@override String get sheetIntroDegraded => 'Dein Gerät schränkt ein, wann Pleazy im Hintergrund herunterladen kann.';
	@override String get reasonBackgroundRestricted => 'Die Hintergrundnutzung von Pleazy ist eingeschränkt. Stelle die Akku- oder Hintergrundnutzung auf „Uneingeschränkt“.';
	@override String get reasonStandbyRestricted => 'Android hat Pleazy in einen eingeschränkten Standby-Modus versetzt. Stelle die Akkunutzung auf „Uneingeschränkt“.';
	...
	@override String get reasonOemUnknown => 'Downloads wurden wiederholt gestoppt, während Pleazy im Hintergrund war. Prüfe die Einstellungen zur Akku- oder Hintergrundnutzung von Pleazy.';
...
class _Translations$companionRemote$pairing$de extends Translations$companionRemote$pairing$en {
	...
	// Translations
	@override String get discoveryDescription => 'Pleazy-Geräte mit demselben Plex-Konto erscheinen hier';
	...
	@override String get noDevicesHint => 'Öffne Pleazy auf dem Desktop und nutze dasselbe WLAN';
	...
	@override String get sessionNotFound => 'Gerät nicht gefunden. Stelle sicher, dass Pleazy auf dem Host läuft.';
...
class _Translations$services$deviceCode$de extends Translations$services$deviceCode$en {
	...
	// Translations
	@override String title({required Object service}) => 'Pleazy auf ${service} aktivieren';
...
extension on TranslationsDe {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'auth.localDataRecoveryRequired' => 'Pleazy konnte lokale Anmeldedaten und ausstehende Wiedergabedaten nicht sicher wiederherstellen. Bitte melde dich erneut an.',
			...
			'settings.supportDeveloper' => 'Pleazy unterstützen',
			...
			'settings.importSettingsInvalidFile' => 'Diese Datei ist kein gültiger Pleazy-Einstellungsexport',
			...
			'settings.startInFullscreenDescription' => 'Pleazy beim Start im Vollbildmodus öffnen',
			...
			'settings.exportDialogTitle' => 'Pleazy-Einstellungen exportieren',
			...
			'mediaMenu.deleteScopeUnverifiedProbeFailed' => 'Pleazy konnte nicht prüfen, welche Dateien dadurch entfernt werden. Es könnte also mehr gelöscht werden als das oben genannte Element. Brich ab und versuche es erneut, oder lösche trotzdem.',
			'mediaMenu.deleteScopeUnverifiedNoFileInfo' => 'Dein Server hat für dieses Element keine Dateidetails bereitgestellt, daher kann Pleazy nicht prüfen, welche Dateien entfernt werden. Es könnte mehr gelöscht werden als das oben genannte Element.',
			...
			'profiles.addPlezyProfile' => 'Pleazy-Profil hinzufügen',
			...
			'connections.editMediaBrowserIntro' => ({required Object serverName}) => 'URLs für ${serverName} hinzufügen oder entfernen. Pleazy verwendet die erreichbare URL mit der geringsten Latenz.',
			...
			'accountPreferences.storedOnAccount' => 'Diese Optionen werden auf dem Konto selbst gespeichert, sodass jede damit angemeldete App sie verwendet — auch Pleazy auf deinen anderen Geräten.',
			...
			'startup.failedTitle' => 'Pleazy konnte nicht gestartet werden',
			'startup.failedBody' => 'Beim Start ist etwas schiefgelaufen. Die Details unten zeigen, was fehlgeschlagen ist.',
			'startup.failedBodyRepairable' => 'Die gespeicherte Einstellungsdatei von Pleazy ist beschädigt und muss neu aufgebaut werden, bevor Pleazy starten kann. Erneutes Versuchen hilft nicht – wähle „Speicher reparieren“.',
			...
			'startup.repairBodyCommon' => 'Die Einstellungsdatei von Pleazy ist beschädigt und kann nicht gelesen werden. Beim Reparieren werden alle Einstellungen auf ihre Standardwerte zurückgesetzt.',
			...
			'startup.repairBodySessionsUncertain' => 'Tracker (MAL, AniList, Simkl, Trakt) und Seerr werden separat gespeichert und können erhalten bleiben oder auch nicht. Pleazy teilt dir genau mit, was erhalten blieb.',
			...
			'startup.restartRequiredBody' => 'Deine Daten wurden repariert, aber Pleazy muss neu starten, bevor es sie verwenden kann. Schließe Pleazy und öffne es erneut.',
			'startup.quitPlezy' => 'Pleazy beenden',
			...
			'startup.previousFailureTitle' => 'Pleazy konnte beim letzten Mal nicht starten',
			...
			'downloads.backgroundWarning.sheetIntro' => 'Android verhindert, dass Pleazy zuverlässig im Hintergrund herunterlädt.',
			'downloads.backgroundWarning.sheetIntroDegraded' => 'Dein Gerät schränkt ein, wann Pleazy im Hintergrund herunterladen kann.',
			'downloads.backgroundWarning.reasonBackgroundRestricted' => 'Die Hintergrundnutzung von Pleazy ist eingeschränkt. Stelle die Akku- oder Hintergrundnutzung auf „Uneingeschränkt“.',
			'downloads.backgroundWarning.reasonStandbyRestricted' => 'Android hat Pleazy in einen eingeschränkten Standby-Modus versetzt. Stelle die Akkunutzung auf „Uneingeschränkt“.',
			...
			'downloads.backgroundWarning.reasonOemUnknown' => 'Downloads wurden wiederholt gestoppt, während Pleazy im Hintergrund war. Prüfe die Einstellungen zur Akku- oder Hintergrundnutzung von Pleazy.',
			...
			'companionRemote.pairing.discoveryDescription' => 'Pleazy-Geräte mit demselben Plex-Konto erscheinen hier',
			...
			'companionRemote.pairing.noDevicesHint' => 'Öffne Pleazy auf dem Desktop und nutze dasselbe WLAN',
			...
			'companionRemote.pairing.sessionNotFound' => 'Gerät nicht gefunden. Stelle sicher, dass Pleazy auf dem Host läuft.',
			...
			'trakt.disconnectConfirmBody' => 'Pleazy sendet keine Ereignisse mehr an Trakt. Du kannst jederzeit erneut verbinden.',
			...
			'trakt.watchedSyncDescription' => 'Wenn du Inhalte in Pleazy als gesehen markierst, werden sie auch auf Trakt markiert.',
			'seerr.title' => 'Seerr',
			...
			'seerr.email' => 'E-Mail',
			'seerr.noSignInMethods' => 'Diese Seerr-Instanz bietet keine von Pleazy unterstützte Anmeldemethode.',
			'seerr.instance' => 'Instanz',
			'seerr.disconnectConfirm' => 'Seerr trennen?',
			'seerr.disconnectConfirmBody' => 'Pleazy vergisst diese Seerr-Instanz. Jederzeit erneut verbinden.',
			...
			'services.disconnectConfirmBody' => ({required Object service}) => 'Pleazy aktualisiert ${service} nicht mehr. Jederzeit erneut verbinden.',
			...
			'services.deviceCode.title' => ({required Object service}) => 'Pleazy auf ${service} aktivieren',
			...
			'funscriptSync.connectionSubtitle' => 'Lokalen FunScriptSync-Server einrichten.',
			'funscriptSync.serverUrl' => 'Server-Adresse',
			'funscriptSync.serverUrlHelper' => 'Protokoll und Port angeben, z. B. http://192.168.178.50:3000',
			'funscriptSync.secret' => 'FunScriptSync-Secret',
			'funscriptSync.secretHelper' => 'Verwendet denselben WEBHOOK_SECRET wie der Jellyfin-Webhook.',
			'funscriptSync.testConnection' => 'Verbindung testen',
			'funscriptSync.testing' => 'Verbindung wird getestet â€¦',
			'funscriptSync.connectionSuccessful' => 'Verbindung zu FunScriptSync erfolgreich.',
			'funscriptSync.deleteActiveScene' => 'Stash Scene löschen',
			'funscriptSync.deleteConfirmation' => 'Die aktuell in FunScriptSync aktive Stash-Szene löschen?',
