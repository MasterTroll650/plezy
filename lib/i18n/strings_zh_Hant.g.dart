...
class _Translations$auth$zh_Hant extends Translations$auth$zh {
	...
	@override String get localDataRecoveryRequired => 'Pleazy 無法安全地復原本機登入資料與待處理的播放資料。請重新登入。';
...
class _Translations$settings$zh_Hant extends Translations$settings$zh {
	...
	@override String get supportDeveloper => '贊助 Pleazy';
	...
	@override String get importSettingsInvalidFile => '此檔案不是有效的 Pleazy 設定匯出檔';
	...
	@override String get startInFullscreenDescription => '啟動時直接以全螢幕開啟 Pleazy';
	...
	@override String get exportDialogTitle => '匯出 Pleazy 設定';
}
...
class _Translations$mediaMenu$zh_Hant extends Translations$mediaMenu$zh {
	...
	@override String get deleteScopeUnverifiedProbeFailed => 'Pleazy 無法確認此操作會刪除哪些檔案，因此刪除範圍可能超出上方所列的項目。請取消後重試，或仍要刪除。';
	@override String get deleteScopeUnverifiedNoFileInfo => '您的伺服器未提供此項目的檔案資訊，因此 Pleazy 無法確認此操作會刪除哪些檔案。刪除範圍可能超出上方所列的項目。';
...
class _Translations$profiles$zh_Hant extends Translations$profiles$zh {
	...
	// Translations
	@override String get addPlezyProfile => '新增 Pleazy 使用者設定檔';
...
class _Translations$connections$zh_Hant extends Translations$connections$zh {
	...
	@override String editMediaBrowserIntro({required Object serverName}) => '為 ${serverName} 新增或移除 URL。Pleazy 將使用延遲最低且可連線的 URL。';
}
...
class _Translations$accountPreferences$zh_Hant extends Translations$accountPreferences$zh {
	...
	@override String get storedOnAccount => '這些選項會儲存在帳戶本身，因此登入該帳戶的所有應用程式都會使用它們，包括您其他裝置上的 Pleazy。';
...
class _Translations$startup$zh_Hant extends Translations$startup$zh {
	...
	// Translations
	@override String get failedTitle => 'Pleazy 無法啟動';
	@override String get failedBody => '啟動期間發生問題。下方詳細資料可識別失敗的原因。';
	@override String get failedBodyRepairable => 'Pleazy 儲存的設定檔已損壞，必須先重建才能啟動。重試無法解決問題 — 請選擇「修復儲存空間」。';
	...
	@override String get repairBodyCommon => 'Pleazy 的設定檔已損壞且無法讀取。修復會將所有設定重設為預設值。';
	...
	@override String get repairBodySessionsUncertain => '追蹤服務（MAL、AniList、Simkl、Trakt）與 Seerr 分別儲存，可能保留也可能遺失。Pleazy 會明確告知保留了哪些項目。';
	...
	@override String get restartRequiredBody => '您的資料已修復，但 Pleazy 必須重新啟動才能使用。請關閉 Pleazy 後重新開啟。';
	...
	@override String get previousFailureTitle => 'Pleazy 上次啟動失敗';
}
...
class _Translations$trakt$zh_Hant extends Translations$trakt$zh {
	...
	@override String get disconnectConfirmBody => 'Pleazy 將停止向 Trakt 傳送事件。您可以隨時重新連線。';
	...
	@override String get watchedSyncDescription => '在 Pleazy 中將項目標記為已觀看時，也會在 Trakt 上標記為已觀看。';
}
...
class _Translations$seerr$zh_Hant extends Translations$seerr$zh {
	...
	@override String get noSignInMethods => '此 Seerr 執行個體未提供 Pleazy 支援的登入方式。';
	@override String get instance => '執行個體';
	@override String get disconnectConfirm => '中斷與 Seerr 的連線？';
	@override String get disconnectConfirmBody => 'Pleazy 將忘記此 Seerr 連線資訊。您可以隨時重新連線。';
...
class _Translations$services$zh_Hant extends Translations$services$zh {
	...
	@override String disconnectConfirmBody({required Object service}) => 'Pleazy 將停止更新 ${service}。您可以隨時重新連線。';
...
class _Translations$downloads$backgroundWarning$zh_Hant extends Translations$downloads$backgroundWarning$zh {
	...
	@override String get sheetIntro => 'Android 正在阻止 Pleazy 在背景穩定下載。';
	@override String get sheetIntroDegraded => '你的裝置限制了 Pleazy 可在背景下載的時機。';
	@override String get reasonBackgroundRestricted => 'Pleazy 的背景使用受限。請將其電池用量或背景使用設定為「無限制」。';
	@override String get reasonStandbyRestricted => 'Android 已將 Pleazy 設為受限待命狀態。請將電池用量設為「無限制」。';
	...
	@override String get reasonOemUnknown => 'Pleazy 在背景執行時，下載屢次停止。請檢查 Pleazy 的電池用量或背景使用設定。';
...
class _Translations$companionRemote$pairing$zh_Hant extends Translations$companionRemote$pairing$zh {
	...
	// Translations
	@override String get discoveryDescription => '使用相同 Plex 帳戶的 Pleazy 裝置會顯示在此處';
	...
	@override String get noDevicesHint => '請在電腦上開啟 Pleazy，並確認兩台裝置使用相同的 Wi-Fi 網路';
	...
	@override String get sessionNotFound => '找不到裝置。請確認主機上已啟動 Pleazy。';
...
class _Translations$services$deviceCode$zh_Hant extends Translations$services$deviceCode$zh {
	...
	// Translations
	@override String title({required Object service}) => '在 ${service} 啟用 Pleazy';
...
extension on TranslationsZhHant {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'auth.localDataRecoveryRequired' => 'Pleazy 無法安全地復原本機登入資料與待處理的播放資料。請重新登入。',
			...
			'settings.title' => '設定',
			'settings.supportDeveloper' => '贊助 Pleazy',
			...
			'settings.importSettingsInvalidFile' => '此檔案不是有效的 Pleazy 設定匯出檔',
			...
			'settings.startInFullscreenDescription' => '啟動時直接以全螢幕開啟 Pleazy',
			...
			'settings.exportDialogTitle' => '匯出 Pleazy 設定',
			...
			'mediaMenu.deleteScopeUnverifiedProbeFailed' => 'Pleazy 無法確認此操作會刪除哪些檔案，因此刪除範圍可能超出上方所列的項目。請取消後重試，或仍要刪除。',
			'mediaMenu.deleteScopeUnverifiedNoFileInfo' => '您的伺服器未提供此項目的檔案資訊，因此 Pleazy 無法確認此操作會刪除哪些檔案。刪除範圍可能超出上方所列的項目。',
			...
			'profiles.addPlezyProfile' => '新增 Pleazy 使用者設定檔',
			...
			'connections.editMediaBrowserIntro' => ({required Object serverName}) => '為 ${serverName} 新增或移除 URL。Pleazy 將使用延遲最低且可連線的 URL。',
			...
			'accountPreferences.storedOnAccount' => '這些選項會儲存在帳戶本身，因此登入該帳戶的所有應用程式都會使用它們，包括您其他裝置上的 Pleazy。',
			...
			'startup.failedTitle' => 'Pleazy 無法啟動',
			'startup.failedBody' => '啟動期間發生問題。下方詳細資料可識別失敗的原因。',
			'startup.failedBodyRepairable' => 'Pleazy 儲存的設定檔已損壞，必須先重建才能啟動。重試無法解決問題 — 請選擇「修復儲存空間」。',
			...
			'startup.repairBodyCommon' => 'Pleazy 的設定檔已損壞且無法讀取。修復會將所有設定重設為預設值。',
			...
			'startup.repairBodySessionsUncertain' => '追蹤服務（MAL、AniList、Simkl、Trakt）與 Seerr 分別儲存，可能保留也可能遺失。Pleazy 會明確告知保留了哪些項目。',
			'startup.repairConfirm' => '修復',
			'startup.repairSucceeded' => '儲存空間已修復',
			'startup.repairNeedsRestart' => '儲存空間已修復 — 需要重新啟動',
			'startup.restartRequiredBody' => '您的資料已修復，但 Pleazy 必須重新啟動才能使用。請關閉 Pleazy 後重新開啟。',
			...
			'startup.previousFailureTitle' => 'Pleazy 上次啟動失敗',
			...
			'downloads.backgroundWarning.sheetIntro' => 'Android 正在阻止 Pleazy 在背景穩定下載。',
			'downloads.backgroundWarning.sheetIntroDegraded' => '你的裝置限制了 Pleazy 可在背景下載的時機。',
			'downloads.backgroundWarning.reasonBackgroundRestricted' => 'Pleazy 的背景使用受限。請將其電池用量或背景使用設定為「無限制」。',
			'downloads.backgroundWarning.reasonStandbyRestricted' => 'Android 已將 Pleazy 設為受限待命狀態。請將電池用量設為「無限制」。',
			...
			'downloads.backgroundWarning.reasonOemUnknown' => 'Pleazy 在背景執行時，下載屢次停止。請檢查 Pleazy 的電池用量或背景使用設定。',
			...
			'companionRemote.pairing.discoveryDescription' => '使用相同 Plex 帳戶的 Pleazy 裝置會顯示在此處',
			...
			'companionRemote.pairing.noDevicesHint' => '請在電腦上開啟 Pleazy，並確認兩台裝置使用相同的 Wi-Fi 網路',
			...
			'companionRemote.pairing.sessionNotFound' => '找不到裝置。請確認主機上已啟動 Pleazy。',
			...
			'trakt.disconnectConfirmBody' => 'Pleazy 將停止向 Trakt 傳送事件。您可以隨時重新連線。',
			'trakt.scrobble' => '即時同步記錄（Scrobble）',
			'trakt.scrobbleDescription' => '在播放時向 Trakt 傳送播放、暫停和停止等狀態。',
			'trakt.watchedSync' => '同步已觀看狀態',
			'trakt.watchedSyncDescription' => '在 Pleazy 中將項目標記為已觀看時，也會在 Trakt 上標記為已觀看。',
			'seerr.title' => 'Seerr',
			...
			'seerr.email' => '電子郵件',
			'seerr.noSignInMethods' => '此 Seerr 執行個體未提供 Pleazy 支援的登入方式。',
			'seerr.instance' => '執行個體',
			'seerr.disconnectConfirm' => '中斷與 Seerr 的連線？',
			'seerr.disconnectConfirmBody' => 'Pleazy 將忘記此 Seerr 連線資訊。您可以隨時重新連線。',
			'seerr.request' => '請求',
			...
			'services.disconnectConfirmBody' => ({required Object service}) => 'Pleazy 將停止更新 ${service}。您可以隨時重新連線。',
			...
			'services.deviceCode.title' => ({required Object service}) => '在 ${service} 啟用 Pleazy',
